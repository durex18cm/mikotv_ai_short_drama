...
export const MOCK_VISUAL_STYLES: VisualStyle[] = [
  {
    ...
    tags: ['历史', '战争', '现实'],
    imageUrl: '/images/visual-styles/realistic-cinematic.png',
  ...
  },
  {
    ...
    tags: ['历史', '武侠', '神话'],
    imageUrl: '/images/visual-styles/epic-chinese.png',
  ...
  },
  {
    ...
    tags: ['幻想', '青春', '轻喜剧'],
    imageUrl: '/images/visual-styles/anime.png',
  ...
  },
  {
    ...
    tags: ['战争', '玄幻', '科幻'],
    imageUrl: '/images/visual-styles/game-cg.png',
  ...
  },
  {
    ...
    tags: ['古风', '诗意', '历史叙事'],
    imageUrl: '/images/visual-styles/ink-wash.png',
  ...
  },
  {
    ...
    tags: ['现代', '都市', '快节奏'],
    imageUrl: '/images/visual-styles/short-drama.png',
